    ...
    function () {
        ...
        Route::group(
            ...
            function () {
                ...
                Route::get('/mission-vision-values', 'MissionVisionValues')->name('mission.vision.values');
                Route::get('/executive-director-message', 'ExecutiveDirectorMessage')->name('executive.director.message');
                Route::get('/executive-committee', 'ExecutiveCommittee')->name('executive.committee');
    ...
    function () {
        ...
        Route::group(
            ...
            function () {
                ...
                Route::post('/status-update/{id}', 'JobApplyStatusUpdate')->name('status.update');
            },
        );
        ...
        // Media Video All Routes
        Route::group(
            [
                'prefix' => 'media-video',
                'controller' => MediaVideoController::class,
                'as' => 'media_video.',
            ],
            function () {
                Route::get('/list', 'MediaVideoList')->name('list');
                Route::get('/add', 'MediaVideoAdd')->name('add');
                Route::post('/store', 'MediaVideoStore')->name('store');
                Route::get('/edit/{id}', 'MediaVideoEdit')->name('edit');
                Route::post('/update', 'MediaVideoUpdate')->name('update');
                Route::get('/delete/{id}', 'MediaVideoDelete')->name('delete');
            },
        );
        ...
        Route::group(
            ...
            function () {
                Route::get('/list', 'InstitutionList')->name('list');
                Route::get('/add', 'InstitutionAdd')->name('add');
                Route::post('/store', 'InstitutionStore')->name('store');
                Route::get('/edit/{id}', 'InstitutionEdit')->name('edit');
                Route::post('/update', 'InstitutionUpdate')->name('update');
                Route::get('/delete/{id}', 'InstitutionDelete')->name('delete');
            },
        );
        ...
        Route::group(
            ...
            function () {
                Route::get('/list', 'NoticeList')->name('list');
                Route::get('/add', 'NoticeAdd')->name('add');
                Route::post('/store', 'NoticeStore')->name('store');
