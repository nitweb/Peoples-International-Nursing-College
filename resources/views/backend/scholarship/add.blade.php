{{-- resources/views/backend/scholarship/add.blade.php --}}
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form id="form" action="{{ route('admin.scholarship.store') }}" method="post" enctype="multipart/form-data" data-parsley-validate>
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="coverage" value="{{ old('coverage') }}" placeholder="e.g. 50% Tuition Waiver, Full Free Studentship">
                                        </div>
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea class="summernote" name="eligibility">{{ old('eligibility') }}</textarea>
                                        </div>
