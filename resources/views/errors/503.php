...
<body class="min-h-screen flex items-center justify-center text-[var(--ink)] px-6 py-12 relative overflow-hidden">
    ...
    <main class="relative z-10 max-w-xl w-full text-center">
        ...
        <!-- Site Logo -->
        <img src="/frontend/assets/images/logo_white.svg" alt="People's International Foundation" class="max-w-[300px] mx-auto mb-10 opacity-90" onerror="this.style.display='none'">
