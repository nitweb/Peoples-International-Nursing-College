    ...
    <section class="team-page-section centred bg-color-1">
        ...
        <div class="auto-container">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 team-block d-flex">
                        <div class="team-block-two w-100">
                            <div class="inner-box d-flex flex-column h-100">
                                <figure class="image-box media-thumb" style="width: 100%; height: 190px; overflow: hidden; margin: 0 auto; position: relative; cursor: pointer; flex-shrink: 0;" data-toggle="modal" data-target="#media_video_modal" data-embed="{{ $item->embed_url }}" data-id="{{ $item->id }}">
                                ...
                                <div class="lower-content d-flex flex-column flex-grow-1 justify-content-between">
                                    <h3><a href="#!" class="media-thumb" data-toggle="modal" data-target="#media_video_modal" data-embed="{{ $item->embed_url }}" data-id="{{ $item->id }}">{{ $item->title }}</a></h3>
            ...
            <div class="btn-box text-center" style="margin-top: 20px;">
                <a href="{{ route('frontend.media') }}" class="theme-btn-one">View All Videos</a>
            </div>
