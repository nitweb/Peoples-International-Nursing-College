...
class AdminController extends Controller
{
    public function AdminDashboard()
    {
        ...
        $institutions = Institution::where('status', 'active')->latest()->get();
        $donation_categories = DonationCategory::latest()->get();
        $donations = Donation::latest()->get();
        $blogs = Blog::where('status', 'active')->latest()->get();
        $contacts = Contact::latest()->get();

        return view('backend.admin.index', compact('services', 'institutions', 'donation_categories', 'donations', 'blogs', 'contacts'));
    }
